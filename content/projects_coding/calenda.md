...
image: /images/coding/caledna.jpg
...
When I started the site, I didn't find any other sites that put the eDNA data online. I had to figure out how to turn pages and pages of CSV data with thousands of taxa into an interactive website. As a starting point, I looked at other sites that had open biodiversity data such as [iNaturalist](https://www.inaturalist.org), [GBIF](https://www.gbif.org), [Atlas of Living Australia](https://www.ala.org.au). I had fun trying to figure out a way to present the eDNA data in a way that both non-scientists like myself and scientists would find useful.
